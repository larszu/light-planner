...
// „Bestehenden Bestand ERSETZEN? Abbrechen = zusammenführen." `true` hiess
// ersetzen, `false` hiess ZUSAMMENFÜHREN — importiert wurde in beiden Fällen.
// Einen Weg, an dieser Stelle noch abzubrechen, gab es nicht. In der Suite
// hat `suite#154` das Zwischenmaß gebracht (Escape und Hintergrund-Klick
