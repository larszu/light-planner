...
const en: Record<string, string> = {
  ...
  'sch.tab.notes': 'Notes',
  'sch.notes.open': 'open',
  'sch.notes.plan': 'Whole plan',
  'sch.notes.truss': 'Truss',
  'sch.notes.target': 'Note target',
  'sch.notes.ph': 'Note \u2013 e.g. too hot on the SL wall, add CTO\u2026',
  'sch.notes.add': 'Add note',
  'sch.notes.done': 'done',
  'sch.notes.remove': 'Remove note',
  'sch.notes.stale': 'Target removed',
  'sch.notes.hint':
  ...
  'sch.return.compared': 'channels compared',
  'sch.return.changed': 'changed',
  'sch.return.onlyConsole': 'console only',
  'sch.return.onlyPlan': 'plan only',
  'sch.return.ambiguous': 'channel used more than once',
  'sch.return.noChannel': 'no channel number',
  'sch.return.columns': 'Columns read',
  'sch.return.ignored': 'not interpreted',
  'sch.return.none': 'none',
  'sch.return.line': 'Line',
  'sch.return.clean': 'The plan matches the console.',
  'sch.return.channel': 'Channel',
  'sch.return.what': 'What',
  'sch.return.label': 'Name',
  'sch.return.field': 'Field',
  'sch.return.inPlan': 'In the plan',
  'sch.return.atConsole': 'At the console',
  'sch.return.oneWay':
